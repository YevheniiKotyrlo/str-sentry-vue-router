...
test('Vue Router 4.5.x with patched Sentry does NOT show deprecation warning', async ({ page }) => {
  const logs: string[] = [];
  page.on('console', (msg) => {
  ...
  // Patch should detect this is NOT a legacy router (VR4 has no 'mode' property)
